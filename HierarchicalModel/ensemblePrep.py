...
model=pickle.load(open(filepath+"HierarchicalModel/"+modelname+"/finalModel.pickle", "rb"))
gc.collect()
...
pickle.dump(result, open(filepath+"HierarchicalModel/"+modelname+"Prediction.pickle", "wb"))
