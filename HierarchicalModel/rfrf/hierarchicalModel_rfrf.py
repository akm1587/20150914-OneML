...
class hierarchicalModel:
    ...
    def fit(self, X, Y1, Y2):
        ...
        model = RandomForestClassifier(random_state=123456, n_estimators=1000, n_jobs=-1)
        ...
        for cst1 in hierarchy.keys():
            ...
            modelTemp = RandomForestClassifier(random_state=123456, n_estimators=5000, n_jobs=-1)
